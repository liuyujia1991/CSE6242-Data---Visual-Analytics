...
$_SESSION['rid1']=$obj_r[2][0];
$_SESSION['rid2']=$obj_r[2][1];
$_SESSION['rid3']=$obj_r[2][2];
...
<h1 class="title2">Wednesday Meal Plan</h1><br>
...
<br>
        ...
        <div class="item row">
         ...
         <div class="description row">
          ...
          <div class="col-xs-6">
			...
			<a class="myButton2" href="../rp/wed.php">To See Nutrition Analysis &nbsp; <span class="input-group-addon"><i class="fa fa-arrow-circle-right"></i></span></a>
          </div>
          <div class="col-xs-3">
		  <form method="POST" action="sf.php"><input type='hidden' name='add21' value='1'><button type="submit" class="myButton"><i class="fa fa-thumbs-up"></i> Add to Favorite</button></form>
		  <form method="POST" action="dis.php"><input type='hidden' name='dis21' value='1'><button type="submit" class="myButton"><i class="fa fa-thumbs-down"></i> Change It</button></form>
		  </div>
        </div>
      </div>
      ...
      <div class="article">
        ...
        <div class="description row">
          ...
          <div class="col-xs-3">
		  <form method="POST" action="sf.php"><input type='hidden' name='add22' value='2'><button type="submit" class="myButton"><i class="fa fa-thumbs-up"></i> Add to Favorite</button></form>
		  <form method="POST" action="dis.php"><input type='hidden' name='dis22' value='2'><button type="submit" class="myButton"><i class="fa fa-thumbs-down"></i> Change It</button></form>
		  </div>
        </div>
      </div>
      ...
      <div class="article">
        ...
        <div class="description row">
          ...
          <div class="col-xs-3">
		  <form method="POST" action="sf.php"><input type='hidden' name='add23' value='3'><button type="submit" class="myButton"><i class="fa fa-thumbs-up"></i> Add to Favorite</button></form>
		  <form method="POST" action="dis.php"><input type='hidden' name='dis23' value='3'><button type="submit" class="myButton"><i class="fa fa-thumbs-down"></i> Change It</button></form>
		  </div>
        </div>
      </div>
	 <br>
