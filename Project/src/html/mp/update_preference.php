...
<html lang="en">
		...
		<script language="javascript">
  		...
  		function display(str) {
			...
			else
			{
				...
				else if(str == 'Asian/ Japanese/ Korean/ Thai')
				{
        		    document.login.American.className = "off";
		...
		<body style="overflow-y:scroll;overflow-x:hidden;"> 
				...
				<h1 class="title2">Update Your Preference</h1><br>
				...
				<form name="login" id="login" method="POST" action="add_preference.php">
					...
					<tr>
	                <th height="40px">Preference</th>
					<th>Value</th>
					<th></th>
					<th>Unit</th>
					</tr>
					<tr  height="60px">
					<th align='left'>Your Gender</th>
					<td align='left'><input type="radio" value="M" name="gender"><label class="subtitle3">Male (M)</label></td>     
                    <td align='left'><input type="radio" value="F" name="gender"><label class="subtitle3">Female (F)</label></td>
					<td></td>
					</tr>
					<tr height="60px">
					<th align='left'>Your Age</th>
					<td align='left'><input type="number" id="age" name="age" min="1" max="120"/></td>
					<td></td>
					<td>years old</td>
					</tr>
					<tr  height="60px">
					<th align='left'>Your Weight</th>
					<td align='left'><input type="number" id="weight" name="weight" min="1" max="300"/></td>
					<td></td>
					<td>kg</td>
					</tr>
					<tr  height="60px">
					<th align='left'>Your Height</th>
					<td align='left'><input type="number" id="height" name="height" min="60" max="250"/></td>
					<td></td>
					<td>cm</td>
					</tr>
					<tr  height="60px">
					<th align='left'>Your Favorite Meals</th>
					<td align='left'>
					<select name="Cuisine" onChange="display(document.login.Cuisine.options[selectedIndex].text);">
 					<option value="" selected="1">--</option>
 					<option value="American">American</option>
 					<option value="Asian">Asian/ Japanese/ Korean/ Thai</option>
					...
					<option value="Southern">Southern & Soul Food</option>
 					...
 					<div id="label" class="off">Meals:</div>
					...
					<option value="Cajun-Wings-1335820" selected="Cajun Wings">Southern Shrimp Cheese Grits</option>
					...
					<option value="Sliced-Beef-with-Enoki-Mushrooms---Japanese-Style-1336447">Sliced Beef with Enoki Mushrooms---Japanese-Style</option>
					...
					<br>
				    <input class="myButton" type="submit" value="Update"/><br><br>
				</form>
				</div>
