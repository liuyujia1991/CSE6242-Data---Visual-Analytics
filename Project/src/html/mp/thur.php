...
$_SESSION['rid1']=$obj_r[3][0];
$_SESSION['rid2']=$obj_r[3][1];
$_SESSION['rid3']=$obj_r[3][2];
...
<h1 class="title2">Thursday Meal Plan</h1><br>
...
<br>
        ...
        <div class="item row">
         ...
         <div class="description row">
          ...
          <div class="col-xs-6">
			...
			<a class="myButton2" href="../rp/thur.php">To See Nutrition Analysis &nbsp; <span class="input-group-addon"><i class="fa fa-arrow-circle-right"></i></span></a>
          </div>
          <div class="col-xs-3">
		  <form method="POST" action="sf.php"><input type='hidden' name='add31' value='1'><button type="submit" class="myButton"><i class="fa fa-thumbs-up"></i> Add to Favorite</button></form>
		  <form method="POST" action="dis.php"><input type='hidden' name='dis31' value='1'><button type="submit" class="myButton"><i class="fa fa-thumbs-down"></i> Change It</button></form>
		  </div>
        </div>
      </div>
      ...
      <div class="article">
        ...
        <div class="description row">
          ...
          <div class="col-xs-3">
		  <form method="POST" action="sf.php"><input type='hidden' name='add32' value='2'><button type="submit" class="myButton"><i class="fa fa-thumbs-up"></i> Add to Favorite</button></form>
		  <form method="POST" action="dis.php"><input type='hidden' name='dis32' value='2'><button type="submit" class="myButton"><i class="fa fa-thumbs-down"></i> Change It</button></form>
		  </div>
        </div>
      </div>
      ...
      <div class="article">
        ...
        <div class="description row">
          ...
          <div class="col-xs-3">
		  <form method="POST" action="sf.php"><input type='hidden' name='add33' value='3'><button type="submit" class="myButton"><i class="fa fa-thumbs-up"></i> Add to Favorite</button></form>
		  <form method="POST" action="dis.php"><input type='hidden' name='dis33' value='3'><button type="submit" class="myButton"><i class="fa fa-thumbs-down"></i> Change It</button></form>
		  </div>
        </div>
      </div>
	 <br>
	 <br>
	 <br>
 	 <a style="width:45%" class="myButton4" href="../rp/thur.php">To See Thursday's Nutrition Analysis &nbsp; <span class="input-group-addon"><i class="fa fa-arrow-circle-right"></i></span></a>
	 <br>
	 <br>
	 <br>
	 <br>
