...
<option value="sun.php">Sunday</option>
      ...
      <div class="article current">
        <div class="item row">
         ...
         <div class="description row">
          ...
          <div class="col-xs-3"><form method="POST" action="sf.php"><input type='hidden' name='add41' value='1'><input class="myButton" type="submit" value="Add to Favorite"></form></div>
        </div>
      </div>
      ...
      <div class="article">
        ...
        <div class="description row">
          ...
          <div class="col-xs-3"><form method="POST" action="sf.php"><input type='hidden' name='add42' value='1'><input class="myButton" type="submit" value="Add to Favorite"></form></div>
        </div>
      </div>
      ...
      <div class="article">
        ...
        <div class="description row">
          ...
          <div class="col-xs-3"><form method="POST" action="sf.php"><input type='hidden' name='add43' value='1'><input class="myButton" type="submit" value="Add to Favorite"></form></div>
        </div>
      </div>
