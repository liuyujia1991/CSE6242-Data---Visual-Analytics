...
$urln1 = "http://localhost:8080/recipes?recipeID=".$obj_r[1][0];
$urln2 = "http://localhost:8080/recipes?recipeID=".$obj_r[1][1];
$urln3 = "http://localhost:8080/recipes?recipeID=".$obj_r[1][2];

$url1 = "http://localhost:8080/nutrition?recipeID=".$obj_r[1][0];
$url2 = "http://localhost:8080/nutrition?recipeID=".$obj_r[1][1];
$url3 = "http://localhost:8080/nutrition?recipeID=".$obj_r[1][2];
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php if($_SESSION['gender']=='M')
						...
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php if($_SESSION['gender']=='M')
						...
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php if($_SESSION['gender']=='M')
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format($val1_pro/$val_base_pro*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format($val2_pro/$val_base_pro*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format($val3_pro/$val_base_pro*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(0.35*$val1_a/$val_base_a*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(0.35*$val2_a/$val_base_a*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(0.35*$val3_a/$val_base_a*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(1000*$val1_c/$val_base_c*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(1000*$val2_c/$val_base_c*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(1000*$val3_c/$val_base_c*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(0.025*$val1_d/$val_base_d*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(0.025*$val2_d/$val_base_d*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(0.025*$val3_d/$val_base_d*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(1000000*$val1_b12/$val_base_b12*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(1000000*$val2_b12/$val_base_b12*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(1000000*$val3_b12/$val_base_b12*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(1000*$val1_e/$val_base_e*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(1000*$val2_e/$val_base_e*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(1000*$val3_e/$val_base_e*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(1000*$val1_ir/$val_base_ir*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(1000*$val2_ir/$val_base_ir*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(1000*$val3_ir/$val_base_ir*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
			...
			<div class="modal-body">
                  <div >
                    <div >
						...
						<tr>
						<th>Breakfast</th><td><a href="../mp/tues.php"><?php echo $rname1?></a></td><td><?php echo number_format(1000*$val1_ca/$val_base_ca*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Lunch</th><td><a href="../mp/tues.php"><?php echo $rname2?></a></td><td><?php echo number_format(1000*$val2_ca/$val_base_ca*100,2) ?> %</td>
						</tr>
						<tr>
						<th>Dinner</th><td><a href="../mp/tues.php"><?php echo $rname3?></a></td><td><?php echo number_format(1000*$val3_ca/$val_base_ca*100,2) ?> %</td>
						</tr>
						</table>
                    </div>
                  </div>
...
<div id="container">
	 ...
	 <h1 class="bgClip">Tuesday Nutrition Analysis</h1>
	 <br>
	 <br>
