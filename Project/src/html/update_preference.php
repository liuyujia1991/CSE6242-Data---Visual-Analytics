...
<html lang="en">
		...
		<body style="overflow-y:scroll;overflow-x:hidden;"> 
				...
				<form name="login" id="login" method="POST" action="add_preference.php">
					...
					<td colspan="2" align='left'><input type="number" id="weight" name="weight" min="1" max="300"/></td>
					<td>kg</td>
					</tr>
					<tr  height="60px">
					<th align='left'>Your Height</th>
					<td colspan="2" align='left'><input type="number" id="height" name="height" min="60" max="250"/></td>
					<td>cm</td>
					</tr>
					<tr  height="60px">
					...
					<br>
				    <input class="myButton" type="submit" value="Update"/> &nbsp &nbsp &nbsp &nbsp &nbsp<a class="myButton" href="edit.php"/>OK! Go Back!</a><br><br>
				</form>
				</div>
