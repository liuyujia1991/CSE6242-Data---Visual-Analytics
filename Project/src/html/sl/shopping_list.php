...
$replace = array("Â", "¼", "½", "â…“", "-", "_", ":", "/", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "â…", " g ","tablespoons", "Tablespoons", "Tablespoon", "tablespoon", "mls", "ml", "kgs", "kg", "grams", "gram", "tsp", "â", "…", "bottles", "bottle", "Cups", "Cup", "TBS", "Pinchs", "Pinch", "pounds", "pound", "cups", "cup", "tbsp", "cloves", "clove", "of", "lbs", "lb", ".L", "Tbs.", "oz.", "(", ")", "about", "oz", "teaspoons", "teaspoon", "Tbsp", "pinchs", "pinch", "ounces", "ounce", "diced", "beaten", "minced", "finely", "thinly", "chopped", "divided", "drained", "&", "small", "approximately", ",,", ".", "celery", "from", "optional", "scrambled", "minced", "cans", "can", "cans", "C ", "About", "stened", "Â", "SAUCE:", "crushed", "and", "lightly", "to taste", "fren ", ", cut into inch cubes", ", cut into chunks", ", more if you like", ", for serving", ", cut into in slices", ", broken in half", ", cut into inch pieces breasts", "halve", "to ", " s ", "T ", "+ ", "$", " ,", "ml_ ", "ml_", "mL ", "mL", "I used suat", "I used skim");
